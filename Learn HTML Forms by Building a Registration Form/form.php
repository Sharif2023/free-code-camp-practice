...
<body>
  ...
  <form method="post" action='connect.php'>
    ...
    <fieldset>
      ...
      <label for="personal-account"><input id="personal-account" type="radio" name="account-type" value="pa" class="inline"
          checked /> Personal</label>
      <label for="business-account"><input id="business-account" type="radio" name="account-type" value="ba" class="inline" />
        Business</label>
    </fieldset>
    <fieldset>
